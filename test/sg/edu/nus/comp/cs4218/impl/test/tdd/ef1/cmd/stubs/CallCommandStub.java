...
public class CallCommandStub extends CallCommand {
    ...
    public CallCommandStub(List<String> argsList, ApplicationRunner appRunner, ArgumentResolver argumentResolver, CallCommandResults resultType) throws ShellException {
        ...
        switch(resultType){
            case FIRST_SUCCESS:
                try {
                    ...
                    throw new ShellException(FIRST_ERROR_MSG + ignored.getMessage());
                }
                break;
            case SECOND_SUCCESS:
                try{
                    ...
                    throw new ShellException(SECOND_ERROR_MSG + e.getMessage());
                }
                break;
